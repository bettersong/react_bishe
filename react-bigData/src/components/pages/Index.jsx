...
export default class Index extends Component {
    ...
    // 获取数据
    getData = () => {
        axios.get(window.base_url +'/WarnningData/getWarnningDataAPI2')
            .then(res=>{
    ...
    render() {
        const { type, warningdata,indexFlag} = this.state
        console.log(this.state,998877)
        const warnLight = [{id:'1'},{id:'2'},{id:'3'}]
            ...
            return (
                <div className="index_body">
                    ...
                    <div className="head_top">
                        <span className="ht_title">智能数据监控系统</span>
                        <p ref="date" className="time"></p>
                        <div className="warningBox">
                            <ul>
                                {warnLight.map(item=>{
                                    return <li className={type} key={item.id}></li>
                                })}
                            </ul>
                            <span>{type=='normal'?'正常':'异常'}</span>
                        </div>
                    ...
                    <div className="viewBox">
                        ...
                        <div className="viewCenter">
                            <ViewCenter startSpell={this.startSpell.bind(this)} />
                        </div>
